...
const AppointScheduling = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        const res = await axios.get("http://localhost:3000/registerUser/showUser");
  ...
  useEffect(() => {
    ...
    const fetchBooked = async () => {
      try {
        const res = await axios.get("http://localhost:3000/appoinmentUser/appointments/booked-slots", {
  ...
  const handleBooking = async () => {
    ...
    try {
      const res = await axios.post("http://localhost:3000/appoinmentUser/appointments/book", {
        userId: selectedUser,
